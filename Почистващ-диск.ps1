...
#GUI Variables
$FormTitleText = "Програма за почистване на диск от Джим Тайлър (PowerShellEngineer.com)"
$SelectDiskLabelText = "Избор на диск:"
$FreeSpaceLabelText = "Свободно пространство (гигабайти): "
$TotalSpaceLabelText = "Общо пространство (гигабайти): "
$JunkFoundLabelText = "намерени боклуци (гигабайта):"
$CleanDiskBtnText = "Почистване на диска *Изтриване на файлове*"
$SpaceCleanedLabelText = "Почистено пространство (гигабайта): "
$LogFileLabelText = "Намерен лог файл: $abcdefg"
$CreditLabelText = "Сценарий от Джим Тайлър - PowerShellEngineer.com"
$LogFileLocatedText = "Регистрационният файл е намерен"
$AnalyzingDriveText = "Анализиране на устройства..."
$BrowsersAreRunningText = "Браузърите работят... Уведомете потребителя..."
$PleaseCloseBrowsersText = "Моля, затворете всички уеб браузъри и опитайте отново."
$CleaningDriveText = "Почистване на диск..."
